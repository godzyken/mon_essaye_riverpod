...
import 'package:mon_essaye_riverpod/src/features/jobs/data/source/firestore_data_source.dart';
import 'package:mon_essaye_riverpod/src/features/jobs/domain/job.dart';
...
class FirestoreRepository {
  ...
  Future<void> setJob({required UserID uid, required Job job}) => _dataSource
      .setData(path: FirestorePath.job(uid, job.id), data: job.toMap());
